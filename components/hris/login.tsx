...
export function LoginScreen({ onLogin }: { onLogin: () => void }) {
  ...
  const handleEnter = (method: string) => {
    setLoading(true)
    toast.loading("Memverifikasi akun...", { id: "login" })
    setTimeout(() => {
      toast.success("Berhasil masuk", { id: "login", description: `Selamat datang di HRIS HNS IT Center (${method}).` })
      setLoading(false)
      onLogin()
    }, 700)
  }
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="glass-strong rounded-3xl p-8 shadow-2xl shadow-primary/10">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="mt-5 text-2xl font-bold tracking-tight text-foreground text-balance">HRIS HNS IT Center</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="email" type="text" placeholder="nama@hnsitcenter.com" defaultValue="andi.pratama@hnsitcenter.com" className="pl-9 bg-input" />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="password" type="password" placeholder="••••••••" defaultValue="password" className="pl-9 bg-input" />
              </div>
            </div>
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground text-pretty">
            Tekan tombol mana pun untuk masuk dan menjelajahi seluruh halaman aplikasi.
          </p>
        </div>
      </div>
    </main>
